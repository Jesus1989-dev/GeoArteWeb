/**
 * Genera docs/cliente/MANUAL-USUARIO.pdf desde docs/cliente/MANUAL-USUARIO.md
 * Uso: node scripts/docs/generate-manual-usuario-pdf.mjs
 */
...
const mdPath = join(root, "docs", "cliente", "MANUAL-USUARIO.md");
const pdfPath = join(root, "docs", "cliente", "MANUAL-USUARIO.pdf");
